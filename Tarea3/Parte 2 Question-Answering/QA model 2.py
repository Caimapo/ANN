...
plot_model(model, to_file=os.path.join(os.getcwd(),'results','model_CuDNNLSTM.png'))
...
model.save(os.path.join(os.getcwd(),'results','model_CuDNNLSTM_.h5'))

with open(os.path.join(os.getcwd(),'results','model_CuDNNLSTM_history.pickle'), 'wb') as r_file:
    pickle.dump(model_history['history'].history,r_file)
with open(os.path.join(os.getcwd(),'results','model_CuDNNLSTM_time.pickle'), 'wb') as r_file:
